 ...
 */
// @ts-expect-error: implicit any on parameters — legacy JS style helper
 ...
 */
// @ts-expect-error: implicit any on parameters from JS port
...
export class PCSCameraControl extends Script {
  ...
  // @ts-expect-error: constructor destructuring types omitted intentionally
  ...
  set focusPoint(point) {
    // @ts-expect-error: camera.entity may be undefined during initialization/teardown
   ...
   * @private
   */
  // @ts-expect-error: implicit any for parameter 'mode'
  _setMode(mode) {
   ...
   */
  // @ts-expect-error: implicit any for parameter 'focus'
   ...
   */
  // @ts-expect-error: implicit any for parameters 'focus' and 'position'
   ...
   */
  // @ts-expect-error: implicit any for parameter 'dt'
  update(dt) {
    ...
    // @ts-expect-error: camera entity may be undefined during teardown
